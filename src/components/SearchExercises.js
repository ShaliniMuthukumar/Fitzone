...
const SearchExercises = ({ setExercises, bodyPart, setBodyPart }) => {
    ...
    return ( <
        ...
        mb = "49px"
        textAlign = "center" >
        Upgrade your fitness routine with these awesome exercises < br / >
        that will revolutionize your workouts <
        /Typography> <
        ...
        sx = {
            { bgcolor: '#FF2625', color: '#fff', textTransform: 'none', width: { lg: '173px', xs: '80px' }, height: '56px', position: 'absolute', right: '0px', fontSize: { lg: '20px', xs: '14px' } } }
